...
const BRIEFINGS := {
	1: {
		...
		"kontrol": [
			[["W", "A", "S", "D"], "berenang ke segala arah"],
			[["Spasi"], "dash -- meluncur cepat sesaat"],
			[["Esc"], "menu jeda"],
		],
		"bahaya": [
			"Sampah yang lebih BESAR dari mulutmu = kehilangan satu nyawa.",
			"Nyawamu tiga. Habis nyawa, babak diulang.",
			"ARUS DERAS: garis merah melintang memberi aba-aba sedetik sebelumnya.",
		],
		"cara": [
			"Penunjuk di kiri layar memperlihatkan apa saja yang sudah muat di mulutmu.",
			"Naik ukuran = sampah yang tadinya berbahaya jadi santapan.",
			"Ukuran 4: semua sampah bisa ditelan. Ukuran 5: babak penghabisan, sapu sisanya.",
			"GELEMBUNG OKSIGEN memulihkan satu nyawa -- atau memberi dorongan tenaga kalau nyawamu penuh.",
			"Induk Sapu-Sapu: gigit INSANGNYA saat menyala. Dash menghindari terjangannya.",
		],
	},
	2: {
	...
	3: {
		...
		"kontrol": [
			[["W", "A", "S", "D"], "berenang, dan mendorong balok"],
